	...
	<div class="window">
		...
		<div class="main" role="main">
			...
			<div class="featured-movie">
				...
				<p class="corner-title">Önerilen</p>
			...
			<div class="movie-list">
				<div class="title-bar">
					<div class="left">
						<?php include 'mini_list.php'; ?>
					</div> <!-- left -->
					<div class="right">
						<a href="#">Puan <i class="fa fa-angle-down"></i> </a> <!-- class="blue" aktif olan -->
						<a href="#">Yeni <i class="fa fa-angle-down"></i> </a>
						<a href="#">Eski <i class="fa fa-angle-down"></i> </a>
					</div> <!-- right -->
				</div> <!-- title-bar -->
				...
				<ul class="list">
					<li>
						...
						<p class="genre">Vizyon: 24/05/2015</p>
						<p class="genre">IMDB Puanı: 8.5</p>
						<p class="genre">İzlenme: 2500 kişi</p>
					</li>
					<li>
				...
				<a href="#" class="load-more">Daha Fazla Göster <span class="fa fa-plus"></span></a>
